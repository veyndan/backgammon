...
test(`validation`, function(t) {
	t.test(`throw if board has an invalid number of checkers`, t => {
		t.test(`too many`, t => {
...
test(`getMove`, t => {
	t.test(`throw if attempting to move absent checker from point`, t => {
		t.test(String(Player.One), t => {
	...
	t.test(`throw if attempting to move absent checker from bar`, t => {
		t.test(String(Player.One), t => {
			const board = Board.startingPosition();
			t.throws(
	...
	t.test(`prevent move from point to position beyond the bounds of the board`, t => {
		t.test(String(Player.One), t => {
			const board = Board.startingPosition();
	...
	t.test(`allow move from point to empty point`, t => {
		t.test(String(Player.One), t => {
			const board = Board.startingPosition();
	...
	t.test(`allow move from point to point with single checker of playing player's color`, t => {
		t.test(String(Player.One), t => {
	...
	t.test(`allow move from point to point with multiple checkers of playing player's color`, t => {
		t.test(String(Player.One), t => {
			const board = Board.startingPosition();
	...
	t.test(`allow move from point to point with single checker of opposing player's color and move opposing player's checker to bar`, t => {
		t.test(String(Player.One), t => {
	...
	t.test(`prevent move from point to point with multiple checkers of opposing player's color`, t => {
		t.test(String(Player.One), t => {
			const board = Board.startingPosition();
	...
	t.test(`prevent move from point to empty point if bar has checker of playing player's color`, t => {
		t.test(String(Player.One), t => {
	...
	t.test(`prevent move from point to point with single checker of opposing player's color if bar has checker of playing player's color`, t => {
		t.test(String(Player.One), t => {
			const board = new Board([-1, -1, 0, 0, 0, 0, 5, 0, 3, 0, 0, 0, -5, 5, 0, 0, 0, -3, 0, -5, 0, 0, 0, 0, 1, 1]);
			t.deepEqual(board.getMove(Player.One, new Die(5), new Point(6)), null);
			t.end();
		});
		t.test(String(Player.Two), t => {
	...
	t.test(`allow move from bar to empty point`, t => {
		t.test(String(Player.One), t => {
			const board = new Board([0, -2, 0, 0, 0, 0, 5, 0, 3, 0, 0, 0, -5, 5, 0, 0, 0, -3, 0, -5, 0, 0, 0, 0, 1, 1]);
	...
	t.test(`allow move from bar to point with single checker of playing player's color`, t => {
		t.test(String(Player.One), t => {
			const board = new Board([0, -2, 0, 0, 0, 0, 5, 0, 3, 0, 0, 0, -5, 5, 0, 0, 0, -3, 0, -5, 0, 0, 0, 0, 1, 1]);
	...
	t.test(`allow move from bar to point with multiple checkers of playing player's color`, t => {
		t.test(String(Player.One), t => {
	...
	t.test(`allow move from bar to point with single checker of opposing player's color and move opposing player's checker to bar`, t => {
		t.test(String(Player.One), t => {
	...
	t.test(`prevent move from bar to point with multiple checkers of opposing player's color`, t => {
		t.test(String(Player.One), t => {
			const board = new Board([0, -2, 0, 0, 0, 0, 5, 0, 3, 0, 0, 0, -5, 5, 0, 0, 0, -3, 0, -5, 0, 0, 0, 0, 1, 1]);
...
test(`withMove`, t => {
	t.test(`move from point to empty point`, t => {
		t.test(String(Player.One), t => {
			const board = Board.startingPosition();
	...
	t.test(`move from point to point with single checker of playing player's color`, t => {
		t.test(String(Player.One), t => {
			const board = new Board([0, -2, 0, 0, 0, 1, 4, 0, 3, 0, 0, 0, -5, 5, 0, 0, 0, -3, 0, -5, 0, 0, 0, 0, 2, 0]);
	...
	t.test(`move from point to point with multiple checkers of playing player's color`, t => {
		t.test(String(Player.One), t => {
			const board = Board.startingPosition();
	...
	t.test(`move from point to point with single checker of opposing player's color and move opposing player's checker to bar`, t => {
		t.test(String(Player.One), t => {
			const board = new Board([0, -1, 0, 0, -1, 0, 5, 0, 3, 0, 0, 0, -5, 5, 0, 0, 0, -3, 0, -5, 0, 0, 0, 0, 2, 0]);
	...
	t.test(`move from bar to empty point`, t => {
		t.test(String(Player.One), t => {
			const board = new Board([0, -2, 0, 0, 0, 0, 5, 0, 3, 0, 0, 0, -5, 5, 0, 0, 0, -3, 0, -5, 0, 0, 0, 0, 1, 1]);
	...
	t.test(`move from bar to point with single checker of playing player's color`, t => {
		t.test(String(Player.One), t => {
			const board = new Board([0, -2, 0, 0, 0, 0, 5, 0, 3, 0, 0, 0, -5, 5, 0, 0, 0, -3, 0, -5, 0, 0, 0, 0, 1, 1]);
	...
	t.test(`move from bar to point with multiple checkers of playing player's color`, t => {
		t.test(String(Player.One), t => {
			const board = new Board([0, -2, 0, 0, 0, 0, 5, 0, 3, 0, 0, 0, -5, 4, 0, 0, 0, -3, 0, -5, 0, 0, 0, 0, 2, 1]);
	...
	t.test(`move from bar to point with single checker of opposing player's color and move opposing player's checker to bar`, t => {
		t.test(String(Player.One), t => {
			const board = new Board([0, -2, 0, 0, 0, 0, 5, 0, 3, 0, 0, 0, -5, 5, 0, 0, 0, -3, 0, -4, 0, 0, -1, 0, 1, 1]);
