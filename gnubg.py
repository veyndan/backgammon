# ['board', 'calcgammonprice', 'cfevaluate', 'classifypos', 'command', 'cubeinfo', 'dicerolls', 'eq2mwc', 'eq2mwc_stderr', 'errorrating', 'evalcontext', 'evaluate', 'findbestmove',
#  'getevalhintfilter', 'gnubgid', 'hint', 'luckrating', 'match', 'matchchecksum', 'matchid', 'met', 'movetupletostring', 'mwc2eq', 'mwc2eq_stderr', 'navigate', 'nextturn', 'parsemove',
#  'posinfo', 'positionbearoff', 'positionfrombearoff', 'positionfromid', 'positionfromkey', 'positionid', 'positionkey', 'rolloutcontext', 'setevalhintfilter', 'updateui']
